...
def main():  
    st.markdown("<h1 style='color:#ff0000;'>Text Mining | Text Summarization | Sentiment Analysis 📚✂️😊</h1>", unsafe_allow_html=True)
    st.markdown("<p style='color:green'>This app utilizes natural language processing techniques to summarize text and perform sentiment analysis. It leverages NLTK (Natural Language Toolkit) for these tasks. Users can input text, and the app generates both brief and full summaries, allowing for efficient comprehension of textual content. Additionally, the app supports PDF files for summarization and analysis, providing users with a convenient way to process text documents.</p>", unsafe_allow_html=True)
